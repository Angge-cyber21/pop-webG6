...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['selected_item']) && isset($_POST['selected_size'])) {
    ...
    $_SESSION['selected_size'] = $_POST['selected_size'];
...
$menuData = [
    ...
    "Miki Bihon" => [
        ...
        "image" => "https://example.com/mikibihon.jpg"
    ],
    "Bihon sollo" => [
        "prices" => ["Regular" => 80, "Double" => 130, "Family" => 220],
        "image" => "https://example.com/bihonsollo.jpg"
    ],
    "Wanam Fried Chicken" => [
    ...
    "Lumpiang shanghai" => [
        "prices" => ["Regular" => 200],
        "image" => "https://example.com/lumpia.jpg"
    ],
    "Pork Sisig" => [
        "prices" => ["Regular" => 220],
    ...
    "Crispy pata" => [
        "prices" => ["Regular" => 400],
        "image" => "https://example.com/crispy_pata.jpg"
    ],
    "Fish Fillet in Sweet and Sour Sauce" => [
        "prices" => ["Regular" => 220],
        "image" => "https://example.com/fishfillet.jpg"
    ]
];
