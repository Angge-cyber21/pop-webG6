...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $allReservations = []; // NEW: for saving full details into session
    ...
    $_SESSION['reservation'] = $allReservations; // NEW: full reservation details

    echo "<script>window.location.href='choose_restaurant.php';</script>";
    exit();
}
?>
